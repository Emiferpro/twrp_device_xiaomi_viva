...
load_viva_id()
{
    ...
    resetprop "ro.product.product.marketname" "Redmi Note 11 Pro 4G"
    resetprop "ro.product.product.model" "2201116TG"
    resetprop "ro.product.product.name" "viva_id"
    ...
    resetprop "ro.product.system.marketname" "Redmi Note 11 Pro 4G"
    resetprop "ro.product.system.model" "2201116TG"
    resetprop "ro.product.system.name" "viva_id"
    ...
    resetprop "ro.product.system_ext.marketname" "Redmi Note 11 Pro 4G"
    resetprop "ro.product.system_ext.model" "2201116TG"
    resetprop "ro.product.system_ext.name" "viva_id"
    resetprop "ro.product.vendor.brand" "Redmi"
    resetprop "ro.product.vendor.device" "viva_id"
    resetprop "ro.product.vendor.manufacturer" "Xiaomi"
    resetprop "ro.product.vendor.marketname" "Redmi Note 11 Pro 4G"
    resetprop "ro.product.vendor.model" "2201116TG"
    resetprop "ro.product.vendor.name" "viva_id"
